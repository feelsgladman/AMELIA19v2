    ...
    <div className="p-2 flex flex-col h-screen">
      ...
      {session && (
        <div className="border-t border-white py-4 space-y-4">
          <div className="text-base chatRow items-center justify-start bg-gray-700/50 gap-5">
            <img
          ...
          <div
            className="text-base chatRow items-center justify-start bg-gray-700/50 gap-5"
            onClick={() => signOut()}
          >
            <svg
